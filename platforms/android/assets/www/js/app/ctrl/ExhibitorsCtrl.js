define(['jquery', 'libs/uri/URI', 'app/loading'], function ($, URI, Loading) {
    ...
    var controller = {
        ...
        loadData: function () {
            ...
            var storageKey = 'exhibitors';
            Loading.show();
            $.getJSON(config.api.exhibitors, function (data) {
        ...
        getListItemHTML: function (item) {
            ...
            var html = '' +
                '<li class="item-logo-cell"><a href="exhibitor.html?id=' + item.id + '">' +
